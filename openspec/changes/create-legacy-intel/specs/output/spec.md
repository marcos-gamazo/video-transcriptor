...
La aplicación debe generar una transcripción Markdown legible, permitiendo al usuario decidir si incluye información temporal por párrafo. La escritura debe ser incremental para no acumular documentos largos en memoria.
...
La aplicación SHALL escribir el resultado progresivamente en disco.
