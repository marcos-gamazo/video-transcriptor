...
La aplicación debe proporcionar una interfaz gráfica sencilla para usuarios sin conocimientos técnicos, reutilizando el diseño y comportamiento de la versión Apple Silicon actual.
...
La interfaz SHALL mostrar claramente el idioma seleccionado y SHALL limitarse a los idiomas para los que existe un modelo Vosk local disponible.
...
#### Scenario: Idioma sin modelo disponible

* **WHEN** el usuario selecciona un idioma sin modelo Vosk instalado
* **THEN** la interfaz SHALL mostrar la información de instalación o descarga correspondiente.
...
La interfaz SHALL comunicar que la transcripción se realiza localmente.
